...
class Issue(CommonCommand):
    def __init__(self):
        ...
        detail_help_text = "Ишью ([{сообщение}]), либо пересылаемые сообщения - добавляет проблему Петровича, которую нужно решить. Для работы требуется либо пересылаемое сообщение, либо аргумент"
