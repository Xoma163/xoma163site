...
class Stop(CommonCommand):
    def __init__(self):
        ...
        detail_help_text = "Стоп ([{бот/майн/террария} [,{версия}]]) - останавливает работу бота или того, что передано в аргументы. В качестве аргумента принимает майнкрафт, террарию или синичек. Если майнкрафт, то может быть указана версия, 1.12.2 или 1.15.1"
