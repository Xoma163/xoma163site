...
class Restart(CommonCommand):
    def __init__(self):
        ...
        detail_help_text = "Рестарт ([{бот/сайт/майн/террария} [,{версия}]]) - перезагружает бота или то, что передано в аргументах. В качестве аргумента принимает майнкрафт, террарию или сайт. Если майнкрафт, то может быть указана версия, 1.12.2 или 1.15.1"
