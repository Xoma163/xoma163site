...
from apps.API_VK.command.commands.APIChat import APIChat
...
from apps.API_VK.command.commands.AdminCommands.Test import Test
from apps.API_VK.command.commands.Audio import Audio
