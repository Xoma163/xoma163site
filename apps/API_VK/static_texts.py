...
def get_praises():
    return ["аплодирую вам стоя", "Ас",
            ...
            "в яблочко!", "Валентина Федосова", "Валентина Федосова  янв  в :", "вау!", "вдумчиво", "вежливый",
            ...
            "Несравненно", "неужели это сам сделал/придумал?", "НравитсяПоказать список оценившихОтветить", "Обалденно",
