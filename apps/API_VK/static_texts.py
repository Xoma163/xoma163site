...
def get_help_text(is_admin, is_student):
    ...
    admin_help = \
        ...
        "̲С̲т̲а̲р̲т/̲С̲т̲о̲п [N]- возобновляет/продолжает работу бота. С параметром можно отключить нужный модуль (синички)\n" \
...
def get_insults():
    return ["Алик", "Алкаш", "алконавт", "Аллаяр", "Альтернативно одаренный", "Амаус", "Аморал",
            ...
            "Белебеня", "Бесстыдник", "Бестия", "Бестолочь", "Бесшабашный", "Бзыря", "Блаженный",
            "Блудоумъ",
            ...
            "Даун", "Дебил", "Дегенерат", "Декадент", "Демон", "Дерево", "Держиморда", "Дерьмо",
            "Дистрофик",
            ...
            "Лоший", "Лудъ", "Любомудръ", "Лябзя", "Лярва", "Макака", "Малахольный", "Мамошка",
            "Мандавошка",
            ...
            "Свербигузка", "Свинья", "Сволочь", "Сдёргоумка", "Сексот", "Секушка", "Сиволапъ",
            "Сивый мерин",
